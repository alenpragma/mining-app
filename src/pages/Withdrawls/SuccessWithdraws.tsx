...
const SuccessWithdraws = () => {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Success Withdraws" />
            ...
            <tbody>
              {depositsData.map((depositsItem, key) => (
                <tr key={key}>
                  ...
                  <td className="border-b border-[#eee] py-5 pr-2 dark:border-strokedark">
...
export default SuccessWithdraws;
