...
import ArrowIcon from '../../images/sidebarIcon/ArrowIcon';
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/user-wallets"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('user-wallets') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/staking' || pathname.includes('staking')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/kyc' || pathname.includes('kyc')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/historys' || pathname.includes('historys')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/historys/monthly-staking-history"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/historys/bizt-conversion-history"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Bizt Conversion History
                            </NavLink>
                          </li>
                        </ul>
                      </div>
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/voucher-purches-history"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Voucher Purches History
                            </NavLink>
                          </li>
                        </ul>
                      </div>
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('leadership-setting') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <IconSetting />
              ...
              <li>
                <NavLink
                  to="/bonus-settings"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('bonus-settings') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <MdOutlineSettingsSuggest className="text-xl dark:bg-meta-4" />
